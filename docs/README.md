...
- [Evidencia de aceptación de US-00](us00-acceptance.md): resultados reales de la validación de la plataforma local.

La documentación sobre fuente de datos, arquitectura analítica, indicadores, modelos, API y dashboard se añadirá con las historias que implementen esas capacidades.
